...
void frnd::chat_on(string uname, string reciepient, char* message)
{
    ...
    strcpy_s(sms[reciepient].mess[sms[reciepient].num_of_message], cuname);
    strcat_s(sms[reciepient].mess[sms[reciepient].num_of_message], ":  ");
    strcat_s(sms[reciepient].mess[sms[reciepient].num_of_message], message);
...
void frnd::unfrnd(string uname)
{
    if (flist.empty())
    {
        cout << "\nSAAAAD!!! You don't have any friends in your list   U+1F62B\a\n";
    }
    else {
        int c = 0, pos = 0, flag = 0;
        string name;
        cout << "\n  U+1F621 U+1F621 U+1F621  I guess you had your differences !!  Enter his name here I'll remove them from your list \n";
        cin >> name;
        vector<string>::iterator i;
        i = flist.begin();
...
void page1()
{
    ...
    cout << "\n\t\t\tWELCOME TO THE 90's DOS-DISCORD\n";
    ...
    while (1)
    {
        ...
        cout << "\nPlease Enter your choice\n  1-Sign_up if you want to have fun with your closed ones\n  2-Sign_in  \n  3-Get out from this place \n \n" << endl;
        cin >> choice;
        ...
        case 1:
        {
            ...
            string username, pwd;
            cout << "\n Choose a  Funky  username\n";
            cin >> username;
            string bee = "\U0001F41D";
            cout << "\nchoose a forgetable " + bee + "password\n";
            cin >> pwd;
            map<string, string>::iterator iuser;
            if (user.empty())
            {
